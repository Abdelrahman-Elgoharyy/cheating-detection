...
public class SimilarityDetection {
    ...
    public static void detectSimilarity( Method method1, Method method2 ) throws Exception {
        // Create two text files to compare
        PrintWriter pw1 = new PrintWriter("file1.txt");
        pw1.println(method1.body);
        pw1.close();

        PrintWriter pw2 = new PrintWriter("file2.txt");
        pw2.println(method2.body);
        pw2.close();
        ...
        JFrame frame = new JFrame("Similarity Detection");
